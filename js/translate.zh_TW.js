var __ = {
    ...
    "Weeks": "週",
    "Months": "月",
    "You have been muted for {TIME} for {REASON}. Please contact support@grindinggear.com if you would like to speak with a GGG staff member directly.": "You have been muted for {TIME} for {REASON}. Please contact support@grindinggear.com if you would like to speak with a GGG staff member directly.",
    "Mute": "Mute",
    ...
    "Upgraded to transaction": "Upgraded to transaction",
    "Upgraded from transaction": "Upgraded from transaction",
    ...
    "Corrupted": "已汙染",
    "Unidentified": "未鑑定",
    "Starts in {before}": "Starts in {before}",
    "Ends in {before}": "Ends in {before}",
    "Starts in {after}": "Starts in {after}",
    "Ends in {after}": "Ends in {after}",
    "Transfer": "Transfer",
    "points to your guild": "points to your guild",
    "point to your guild": "point to your guild",
    "Draft out of sync": "Draft out of sync",
    "Draft up to date": "Draft up to date",
    "[ Expand ]": "[ 展開 ]",
    "[ Collapse ]": "[ 收起 ]",
    " Saved at  ": " Saved at ",
    "Saving draft": "Saving draft",
    "You are editing a saved draft. Click here to edit the original.": "You are editing a saved draft. Click here to edit the original.",
    "Stack Size": "堆疊數量",
    "Talisman Tier:": "魔符階級：",
    "New Note": "New Note",
    "Edit Note": "Edit Note",
    ...
    "Make this image your avatar?": "Make this image your avatar?",
    ...
    "Opted out of physical goods": "Opted out of physical goods",
    "BDB Banned Until": "BDB Banned Until",
    "You don't have enough points!": "你沒有足夠的點數！",
    ...
    "Silver Coin": "銀幣",
    "Apprentice Cartographer's Sextant": "製圖六分儀．見習",
    "Journeyman Cartographer's Sextant": "製圖六分儀．學者",
    "Master Cartographer's Sextant": "製圖六分儀．大師",
    ...
    "Unknown": "未知",
    "Copied!": "已複製!",
    "Added {PLAYER} to your ignore list": "將{流亡者}加入黑名單",
    ...
    "Could not initiate Xsolla payment, please try again later or contact support@grindinggear.com": "Could not initiate Xsolla payment, please try again later or contact support@grindinggear.com",
    "Failed to create Xsolla transaction, please try again later or contact support@grindinggear.com": "Failed to create Xsolla transaction, please try again later or contact support@grindinggear.com",
    ...
    "No matches.": "無符合道具.",
    "{i} selected": "{i} 選取",
    "Check out with Credit/Debit Card.": "Check out with Credit/Debit Card.",
    ...
    "Players will have their Online/Offline status updated every minute.": "每分鐘都會更新玩家們的在線狀態。",
    ...
    "We provide an easy copy-pasteable message to whisper the player with, as well as a link to PM the player on the main Path of Exile website.": "網站提供簡易與玩家聯繫的密語貼文，也可使用流亡黯道網站的私人訊息功能聯絡玩家。",
    ...
    "Failed to load the address.": "Failed to load the address.",
    "Would you like to proceed with the purchase?": "Would you like to proceed with the purchase?",
    "Purchase Successful": "Purchase Successful",
    "Login Required": "Login Required",
    "Account Creation Required": "Account Creation Required",
    ...
    "Your connection has been restricted": "你的連線受阻",
    ...
    "Valdo's Rest": "瓦爾多憩地",
    "Lira Arthain": "里拉．奧斯汀",
    "Metamorph Brain": "鍊魔腦髓",
    "Metamorph Eye": "鍊魔眼睛",
    "Metamorph Lung": "鍊魔肺臟",
    "Metamorph Heart": "鍊魔心臟",
    "Metamorph Liver": "鍊魔肝臟",
    "Current": "當前",
    ...
    "Talisman Level": "魔符等級",
    "Generate Link": "產生連結",
    "You have reached the maximum number of invitation links.": "You have reached the maximum number of invitation links.",
    ...
    "Already Owned": "已擁有",
    "Was": "原本為",
    "Your Guild does not have enough points to purchase this item": "你的公會沒有足夠的點數購買此物品",
    "You must be a Guild leader to purchase this": "你必須是公會會長才能購買這項物品",
    "GIVE POINTS TO GUILD": "給予公會點數",
    ...
    "You have been muted for {TIME} for breaching our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted for {TIME} for breaching our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "You have been muted permanently for breaching our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted permanently for breaching our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "You have been muted for {TIME} due to the following statement \"{MESSAGE}\" as this breaches our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted for {TIME} due to the following statement \"{MESSAGE}\" as this breaches our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "You have been muted permanently due to the following statement \"{MESSAGE}\" as this breaches our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted permanently due to the following statement \"{MESSAGE}\" as this breaches our Code of Conduct. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "You have been muted for {TIME} for trading in the global chat. For future trading, please use the dedicated trade channels. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted for {TIME} for trading in the global chat. For future trading, please use the dedicated trade channels. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "You have been muted permanently for trading in the global chat. For future trading, please use the dedicated trade channels. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "You have been muted permanently for trading in the global chat. For future trading, please use the dedicated trade channels. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "Your character will be renamed shortly for breaching our Code of Conduct. This will log you out of the game client. When you log back in you will need to select a new character name. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com": "Your character will be renamed shortly for breaching our Code of Conduct. This will log you out of the game client. When you log back in you will need to select a new character name. If you have any questions about our in game chat rules, or anything else, please contact support@grindinggear.com",
    "Original Cost": "原價",
    "Sale Cost": "特價",
    "Discount": "折扣",
    "Image": "圖片",
    ...
    "Sign in": "Sign in",
    "all sign in options": "all sign in options",
    "Please complete the reCAPTCHA": "Please complete the reCAPTCHA",
    "Sign in instead": "改為登入",
    "Choose how you would like to sign up:": "Choose how you would like to sign up:",
    "Log in": "登入",
    "Loading posts...": "載入貼文...",
